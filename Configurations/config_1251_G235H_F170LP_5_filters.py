...
Yh_height, Yh_width = 14, 14 # rectangular size (in NIRSpec pixels) of the fusion fov, it must be even if center pix coord is .5 and odd if .0
...
NIRCam_throughputs = ["Throughputs/NIRCam/NRCB1_F182M_system_throughput.txt",
                      "Throughputs/NIRCam/NRCB1_F187N_system_throughput.txt",
...
fusion_name = "1251_Titan_F170LP_166_230um_5_filters_"
fuse = fusion.fusion
